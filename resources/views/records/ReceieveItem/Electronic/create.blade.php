            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10"> Received Eletronic Items</h5>
                    </div>
                    <ul class="breadcrumb">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <hr>
                <div class="card-body">
                    <form action="{{route('item.receive.electronic.store')}}" method="POST" id="myForm">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                ...
                <div class="row pagePadding">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="state" class="form-control select2" required>
                                    ...
                                    <option value="1"> Item Returned</option>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group row">
                            <label for="colFormLabel" class="col-sm-3 col-form-label">Date Received</label>
                            <div class="col-sm-9">
                                <input type="text" name="receive_date" class="form-control" id="todaydatefordeparture" value="{{ date("m/d/Y") }}" readonly >
                            </div>
                        </div>
                    </div>
                </div>
